...
class YInputCaptureData
{
    ...
    protected $_fmt = 0;                            // int
    protected $_var1size = 0;                            // int
    protected $_var2size = 0;                            // int
    protected $_var3size = 0;                            // int
    protected $_nVars = 0;                            // int
    protected $_recOfs = 0;                            // int
    protected $_nRecs = 0;                            // int
    protected $_samplesPerSec = 0;                            // int
    protected $_trigType = 0;                            // int
    protected $_trigVal = 0;                            // float
    protected $_trigPos = 0;                            // int
    protected $_trigUTC = 0;                            // float
    protected $_var1unit = "";                           // string
    protected $_var2unit = "";                           // string
    protected $_var3unit = "";                           // string
    protected $_var1samples = [];                           // floatArr
    protected $_var2samples = [];                           // floatArr
    protected $_var3samples = [];                           // floatArr
...
class YInputCapture extends YFunction
{
    ...
    protected $_lastCaptureTime = self::LASTCAPTURETIME_INVALID; // Time
    protected $_nSamples = self::NSAMPLES_INVALID;       // UInt31
    protected $_samplingRate = self::SAMPLINGRATE_INVALID;   // UInt31
    protected $_captureType = self::CAPTURETYPE_INVALID;    // CaptureTypeAll
    protected $_condValue = self::CONDVALUE_INVALID;      // MeasureVal
    protected $_condAlign = self::CONDALIGN_INVALID;      // Percent
    protected $_captureTypeAtStartup = self::CAPTURETYPEATSTARTUP_INVALID; // CaptureTypeAll
    protected $_condValueAtStartup = self::CONDVALUEATSTARTUP_INVALID; // MeasureVal
