...
/*********************************************************************
 *
 *  $Id: yocto_multicellweighscale.php 52899 2023-01-25 11:45:44Z seb $
 *
...
if (!defined('Y_EXTERNALSENSE_FALSE')) {
    define('Y_EXTERNALSENSE_FALSE', 0);
}
if (!defined('Y_EXTERNALSENSE_TRUE')) {
    define('Y_EXTERNALSENSE_TRUE', 1);
}
if (!defined('Y_EXTERNALSENSE_INVALID')) {
    define('Y_EXTERNALSENSE_INVALID', -1);
}
if (!defined('Y_EXCITATION_OFF')) {
    define('Y_EXCITATION_OFF', 0);
}
if (!defined('Y_EXCITATION_DC')) {
    define('Y_EXCITATION_DC', 1);
}
if (!defined('Y_EXCITATION_AC')) {
    define('Y_EXCITATION_AC', 2);
}
if (!defined('Y_EXCITATION_INVALID')) {
    define('Y_EXCITATION_INVALID', -1);
}
if (!defined('Y_CELLCOUNT_INVALID')) {
    define('Y_CELLCOUNT_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_TEMPAVGADAPTRATIO_INVALID')) {
    define('Y_TEMPAVGADAPTRATIO_INVALID', YAPI_INVALID_DOUBLE);
}
if (!defined('Y_TEMPCHGADAPTRATIO_INVALID')) {
    define('Y_TEMPCHGADAPTRATIO_INVALID', YAPI_INVALID_DOUBLE);
}
if (!defined('Y_COMPTEMPAVG_INVALID')) {
    define('Y_COMPTEMPAVG_INVALID', YAPI_INVALID_DOUBLE);
}
if (!defined('Y_COMPTEMPCHG_INVALID')) {
    define('Y_COMPTEMPCHG_INVALID', YAPI_INVALID_DOUBLE);
}
if (!defined('Y_COMPENSATION_INVALID')) {
    define('Y_COMPENSATION_INVALID', YAPI_INVALID_DOUBLE);
}
if (!defined('Y_ZEROTRACKING_INVALID')) {
...
class YMultiCellWeighScale extends YSensor
{
    ...
    protected $_cellCount = self::CELLCOUNT_INVALID;      // UInt31
    protected $_externalSense = self::EXTERNALSENSE_INVALID;  // Bool
    protected $_excitation = self::EXCITATION_INVALID;     // ExcitationMode
    protected $_tempAvgAdaptRatio = self::TEMPAVGADAPTRATIO_INVALID; // MeasureVal
    protected $_tempChgAdaptRatio = self::TEMPCHGADAPTRATIO_INVALID; // MeasureVal
    protected $_compTempAvg = self::COMPTEMPAVG_INVALID;    // MeasureVal
    protected $_compTempChg = self::COMPTEMPCHG_INVALID;    // MeasureVal
    protected $_compensation = self::COMPENSATION_INVALID;   // MeasureVal
    protected $_zeroTracking = self::ZEROTRACKING_INVALID;   // MeasureVal
    ...
    public function cellCount(): int
{
    ...
    public function setCellCount(int $newval)
{
    ...
    public function externalSense(): int
{
    ...
    public function setExternalSense(int $newval)
{
 ...
 * weighing scale sensor.
 */
function yFindMultiCellWeighScale(string $func): YMultiCellWeighScale
{
 ...
 *         if there are none.
 */
function yFirstMultiCellWeighScale(): ?YMultiCellWeighScale
{
