...
/*********************************************************************
 *
 *  $Id: yocto_spiport.php 58914 2024-01-12 09:29:29Z seb $
 *
...
if (!defined('Y_SSPOLARITY_ACTIVE_LOW')) {
    define('Y_SSPOLARITY_ACTIVE_LOW', 0);
}
if (!defined('Y_SSPOLARITY_ACTIVE_HIGH')) {
    define('Y_SSPOLARITY_ACTIVE_HIGH', 1);
}
if (!defined('Y_SSPOLARITY_INVALID')) {
    define('Y_SSPOLARITY_INVALID', -1);
}
if (!defined('Y_SHIFTSAMPLING_OFF')) {
    define('Y_SHIFTSAMPLING_OFF', 0);
}
if (!defined('Y_SHIFTSAMPLING_ON')) {
    define('Y_SHIFTSAMPLING_ON', 1);
}
if (!defined('Y_SHIFTSAMPLING_INVALID')) {
    define('Y_SHIFTSAMPLING_INVALID', -1);
}
...
class YSpiPort extends YFunction
{
    ...
    protected $_spiMode = self::SPIMODE_INVALID;        // SpiMode
    protected $_ssPolarity = self::SSPOLARITY_INVALID;     // Polarity
    protected $_shiftSampling = self::SHIFTSAMPLING_INVALID;  // OnOff
