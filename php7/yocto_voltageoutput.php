...
/*********************************************************************
 *
 *  $Id: yocto_voltageoutput.php 56082 2023-08-15 14:57:14Z mvuilleu $
 *
...
if (!defined('Y_CURRENTVOLTAGE_INVALID')) {
...
class YVoltageOutput extends YFunction
{
    ...
    protected $_currentVoltage = self::CURRENTVOLTAGE_INVALID; // MeasureVal
 ...
 * @return YVoltageOutput  a YVoltageOutput object allowing you to drive the voltage output.
 */
function yFindVoltageOutput(string $func): YVoltageOutput
{
 ...
 *         if there are none.
 */
function yFirstVoltageOutput(): ?YVoltageOutput
{
