...
/*********************************************************************
 *
 *  $Id: yocto_watchdog.php 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
class YWatchdog extends YFunction
{
    ...
    protected $_state = self::STATE_INVALID;          // Toggle
    protected $_stateAtPowerOn = self::STATEATPOWERON_INVALID; // ToggleAtPowerOn
    protected $_maxTimeOnStateA = self::MAXTIMEONSTATEA_INVALID; // Time
    protected $_maxTimeOnStateB = self::MAXTIMEONSTATEB_INVALID; // Time
    protected $_output = self::OUTPUT_INVALID;         // OnOff
    ...
    protected $_countdown = self::COUNTDOWN_INVALID;      // Time
    protected $_autoStart = self::AUTOSTART_INVALID;      // OnOff
    protected $_running = self::RUNNING_INVALID;        // OnOff
    protected $_triggerDelay = self::TRIGGERDELAY_INVALID;   // Time
    protected $_triggerDuration = self::TRIGGERDURATION_INVALID; // Time
    protected $_lastTrigger = self::LASTTRIGGER_INVALID;    // UInt31
