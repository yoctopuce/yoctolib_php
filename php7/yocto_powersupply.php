...
/*********************************************************************
 *
 *  $Id: yocto_powersupply.php 52899 2023-01-25 11:45:44Z seb $
 *
...
class YPowerSupply extends YFunction
{
    ...
    protected $_voltageSetPoint = self::VOLTAGESETPOINT_INVALID; // MeasureVal
    protected $_currentLimit = self::CURRENTLIMIT_INVALID;   // MeasureVal
    protected $_powerOutput = self::POWEROUTPUT_INVALID;    // OnOff
    protected $_voltageSense = self::VOLTAGESENSE_INVALID;   // VoltageSense
    ...
    protected $_vInt = self::VINT_INVALID;           // MeasureVal
    protected $_ldoTemperature = self::LDOTEMPERATURE_INVALID; // MeasureVal
    protected $_voltageTransition = self::VOLTAGETRANSITION_INVALID; // AnyFloatTransition
    protected $_voltageAtStartUp = self::VOLTAGEATSTARTUP_INVALID; // MeasureVal
    protected $_currentAtStartUp = self::CURRENTATSTARTUP_INVALID; // MeasureVal
