...
/*********************************************************************
 *
 *  $Id: yocto_daisychain.php 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
if (!defined('Y_DAISYSTATE_READY')) {
    define('Y_DAISYSTATE_READY', 0);
}
if (!defined('Y_DAISYSTATE_IS_CHILD')) {
    define('Y_DAISYSTATE_IS_CHILD', 1);
}
if (!defined('Y_DAISYSTATE_FIRMWARE_MISMATCH')) {
    define('Y_DAISYSTATE_FIRMWARE_MISMATCH', 2);
}
if (!defined('Y_DAISYSTATE_CHILD_MISSING')) {
    define('Y_DAISYSTATE_CHILD_MISSING', 3);
}
if (!defined('Y_DAISYSTATE_CHILD_LOST')) {
    define('Y_DAISYSTATE_CHILD_LOST', 4);
}
if (!defined('Y_DAISYSTATE_INVALID')) {
    define('Y_DAISYSTATE_INVALID', -1);
}
if (!defined('Y_CHILDCOUNT_INVALID')) {
    define('Y_CHILDCOUNT_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_REQUIREDCHILDCOUNT_INVALID')) {
...
class YDaisyChain extends YFunction
{
    ...
    protected $_daisyState = self::DAISYSTATE_INVALID;     // DaisyState
    protected $_childCount = self::CHILDCOUNT_INVALID;     // UInt31
    protected $_requiredChildCount = self::REQUIREDCHILDCOUNT_INVALID; // UInt31
 ...
 * @return YDaisyChain  a YDaisyChain object allowing you to drive the module chain.
 */
function yFindDaisyChain(string $func): YDaisyChain
{
 ...
 *         if there are none.
 */
function yFirstDaisyChain(): ?YDaisyChain
{
