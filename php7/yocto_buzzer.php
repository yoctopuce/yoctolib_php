...
/*********************************************************************
 *
 *  $Id: yocto_buzzer.php 52899 2023-01-25 11:45:44Z seb $
 *
...
if (!defined('Y_PLAYSEQSIZE_INVALID')) {
    define('Y_PLAYSEQSIZE_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_PLAYSEQMAXSIZE_INVALID')) {
    define('Y_PLAYSEQMAXSIZE_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_PLAYSEQSIGNATURE_INVALID')) {
...
class YBuzzer extends YFunction
{
    ...
    protected $_playSeqSize = self::PLAYSEQSIZE_INVALID;    // UInt31
    protected $_playSeqMaxSize = self::PLAYSEQMAXSIZE_INVALID; // UInt31
    protected $_playSeqSignature = self::PLAYSEQSIGNATURE_INVALID; // UInt31
 ...
 * @return YBuzzer  a YBuzzer object allowing you to drive the buzzer.
 */
function yFindBuzzer(string $func): YBuzzer
{
