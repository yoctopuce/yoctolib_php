...
/*********************************************************************
 *
 *  $Id: yocto_pwmpowersource.php 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
if (!defined('Y_POWERMODE_USB_5V')) {
    define('Y_POWERMODE_USB_5V', 0);
}
if (!defined('Y_POWERMODE_USB_3V')) {
    define('Y_POWERMODE_USB_3V', 1);
}
if (!defined('Y_POWERMODE_EXT_V')) {
    define('Y_POWERMODE_EXT_V', 2);
}
if (!defined('Y_POWERMODE_OPNDRN')) {
    define('Y_POWERMODE_OPNDRN', 3);
}
if (!defined('Y_POWERMODE_INVALID')) {
    define('Y_POWERMODE_INVALID', -1);
}
...
class YPwmPowerSource extends YFunction
{
    ...
    protected $_powerMode = self::POWERMODE_INVALID;      // PwmPwrState
 ...
 * @return YPwmPowerSource  a YPwmPowerSource object allowing you to drive the PWM generator power source.
 */
function yFindPwmPowerSource(string $func): YPwmPowerSource
{
 ...
 *         if there are none.
 */
function yFirstPwmPowerSource(): ?YPwmPowerSource
{
