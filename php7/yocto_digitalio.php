...
/*********************************************************************
 *
 *  $Id: yocto_digitalio.php 52899 2023-01-25 11:45:44Z seb $
 *
...
if (!defined('Y_OUTPUTVOLTAGE_USB_5V')) {
    define('Y_OUTPUTVOLTAGE_USB_5V', 0);
}
if (!defined('Y_OUTPUTVOLTAGE_USB_3V')) {
    define('Y_OUTPUTVOLTAGE_USB_3V', 1);
}
if (!defined('Y_OUTPUTVOLTAGE_EXT_V')) {
    define('Y_OUTPUTVOLTAGE_EXT_V', 2);
}
if (!defined('Y_OUTPUTVOLTAGE_INVALID')) {
    define('Y_OUTPUTVOLTAGE_INVALID', -1);
}
if (!defined('Y_PORTSTATE_INVALID')) {
    define('Y_PORTSTATE_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_PORTDIRECTION_INVALID')) {
    define('Y_PORTDIRECTION_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_PORTOPENDRAIN_INVALID')) {
    define('Y_PORTOPENDRAIN_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_PORTPOLARITY_INVALID')) {
    define('Y_PORTPOLARITY_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_PORTDIAGS_INVALID')) {
    define('Y_PORTDIAGS_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_PORTSIZE_INVALID')) {
...
class YDigitalIO extends YFunction
{
    ...
    protected $_portState = self::PORTSTATE_INVALID;      // BitByte
    protected $_portDirection = self::PORTDIRECTION_INVALID;  // BitByte
    protected $_portOpenDrain = self::PORTOPENDRAIN_INVALID;  // BitByte
    protected $_portPolarity = self::PORTPOLARITY_INVALID;   // BitByte
    protected $_portDiags = self::PORTDIAGS_INVALID;      // DigitalIODiags
    protected $_portSize = self::PORTSIZE_INVALID;       // UInt31
    protected $_outputVoltage = self::OUTPUTVOLTAGE_INVALID;  // IOVoltage
    ...
    public function portState(): int
{
    ...
    public function setPortState(int $newval)
{
    ...
    public function portDirection(): int
{
    ...
    public function setPortDirection(int $newval)
{
    ...
    public function portOpenDrain(): int
{
    ...
    public function setPortOpenDrain(int $newval)
{
    ...
    public function portPolarity(): int
{
    ...
    public function setPortPolarity(int $newval)
{
    ...
    public function outputVoltage(): int
{
    ...
    public function setOutputVoltage(int $newval)
{
 ...
 * @return YDigitalIO  a YDigitalIO object allowing you to drive the digital IO port.
 */
function yFindDigitalIO(string $func): YDigitalIO
{
 ...
 *         if there are none.
 */
function yFirstDigitalIO(): ?YDigitalIO
{
