 ...
 *  $Id: svn_id $
 *
 *  Implements YColorSensor, the high-level API for ColorSensor functions
 *
 *  - - - - - - - - - License information: - - - - - - - - -
 *
...
if (!defined('Y_ESTIMATIONMODEL_REFLECTION')) {
    define('Y_ESTIMATIONMODEL_REFLECTION', 0);
}
if (!defined('Y_ESTIMATIONMODEL_EMISSION')) {
    define('Y_ESTIMATIONMODEL_EMISSION', 1);
}
if (!defined('Y_ESTIMATIONMODEL_INVALID')) {
    define('Y_ESTIMATIONMODEL_INVALID', -1);
}
if (!defined('Y_WORKINGMODE_AUTO')) {
    define('Y_WORKINGMODE_AUTO', 0);
}
if (!defined('Y_WORKINGMODE_EXPERT')) {
    define('Y_WORKINGMODE_EXPERT', 1);
}
if (!defined('Y_WORKINGMODE_AUTOGAIN')) {
    define('Y_WORKINGMODE_AUTOGAIN', 2);
}
if (!defined('Y_WORKINGMODE_INVALID')) {
    define('Y_WORKINGMODE_INVALID', -1);
}
if (!defined('Y_NEARSIMPLECOLORINDEX_BROWN')) {
    define('Y_NEARSIMPLECOLORINDEX_BROWN', 0);
}
if (!defined('Y_NEARSIMPLECOLORINDEX_RED')) {
    define('Y_NEARSIMPLECOLORINDEX_RED', 1);
}
if (!defined('Y_NEARSIMPLECOLORINDEX_ORANGE')) {
    define('Y_NEARSIMPLECOLORINDEX_ORANGE', 2);
}
if (!defined('Y_NEARSIMPLECOLORINDEX_YELLOW')) {
    define('Y_NEARSIMPLECOLORINDEX_YELLOW', 3);
}
if (!defined('Y_NEARSIMPLECOLORINDEX_WHITE')) {
    define('Y_NEARSIMPLECOLORINDEX_WHITE', 4);
}
if (!defined('Y_NEARSIMPLECOLORINDEX_GRAY')) {
    define('Y_NEARSIMPLECOLORINDEX_GRAY', 5);
}
if (!defined('Y_NEARSIMPLECOLORINDEX_BLACK')) {
    define('Y_NEARSIMPLECOLORINDEX_BLACK', 6);
}
if (!defined('Y_NEARSIMPLECOLORINDEX_GREEN')) {
    define('Y_NEARSIMPLECOLORINDEX_GREEN', 7);
}
if (!defined('Y_NEARSIMPLECOLORINDEX_BLUE')) {
    define('Y_NEARSIMPLECOLORINDEX_BLUE', 8);
}
if (!defined('Y_NEARSIMPLECOLORINDEX_PURPLE')) {
    define('Y_NEARSIMPLECOLORINDEX_PURPLE', 9);
}
if (!defined('Y_NEARSIMPLECOLORINDEX_PINK')) {
    define('Y_NEARSIMPLECOLORINDEX_PINK', 10);
}
if (!defined('Y_NEARSIMPLECOLORINDEX_INVALID')) {
    define('Y_NEARSIMPLECOLORINDEX_INVALID', -1);
}
if (!defined('Y_LEDCURRENT_INVALID')) {
    define('Y_LEDCURRENT_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_LEDCALIBRATION_INVALID')) {
    define('Y_LEDCALIBRATION_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_INTEGRATIONTIME_INVALID')) {
    define('Y_INTEGRATIONTIME_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_GAIN_INVALID')) {
    define('Y_GAIN_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_AUTOGAIN_INVALID')) {
    define('Y_AUTOGAIN_INVALID', YAPI_INVALID_STRING);
}
if (!defined('Y_SATURATION_INVALID')) {
    define('Y_SATURATION_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_ESTIMATEDRGB_INVALID')) {
    define('Y_ESTIMATEDRGB_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_ESTIMATEDHSL_INVALID')) {
    define('Y_ESTIMATEDHSL_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_ESTIMATEDXYZ_INVALID')) {
    define('Y_ESTIMATEDXYZ_INVALID', YAPI_INVALID_STRING);
}
if (!defined('Y_ESTIMATEDOKLAB_INVALID')) {
    define('Y_ESTIMATEDOKLAB_INVALID', YAPI_INVALID_STRING);
}
if (!defined('Y_NEARRAL1_INVALID')) {
    define('Y_NEARRAL1_INVALID', YAPI_INVALID_STRING);
}
if (!defined('Y_NEARRAL2_INVALID')) {
    define('Y_NEARRAL2_INVALID', YAPI_INVALID_STRING);
}
if (!defined('Y_NEARRAL3_INVALID')) {
    define('Y_NEARRAL3_INVALID', YAPI_INVALID_STRING);
}
if (!defined('Y_NEARHTMLCOLOR_INVALID')) {
    define('Y_NEARHTMLCOLOR_INVALID', YAPI_INVALID_STRING);
}
if (!defined('Y_NEARSIMPLECOLOR_INVALID')) {
...
class YColorSensor extends YFunction
{
    ...
    protected $_estimationModel = self::ESTIMATIONMODEL_INVALID; // EstimationModel
    protected $_workingMode = self::WORKINGMODE_INVALID;    // WorkingMode
    protected $_ledCurrent = self::LEDCURRENT_INVALID;     // UInt31
    protected $_ledCalibration = self::LEDCALIBRATION_INVALID; // UInt31
    protected $_integrationTime = self::INTEGRATIONTIME_INVALID; // UInt31
    protected $_gain = self::GAIN_INVALID;           // UInt31
    protected $_autoGain = self::AUTOGAIN_INVALID;       // AutoGainConfig
    protected $_saturation = self::SATURATION_INVALID;     // SaturationBits
    protected $_estimatedRGB = self::ESTIMATEDRGB_INVALID;   // U24Color
    protected $_estimatedHSL = self::ESTIMATEDHSL_INVALID;   // U24Color
    protected $_estimatedXYZ = self::ESTIMATEDXYZ_INVALID;   // ColorCoord
    protected $_estimatedOkLab = self::ESTIMATEDOKLAB_INVALID; // ColorCoord
    protected $_nearRAL1 = self::NEARRAL1_INVALID;       // Text
    protected $_nearRAL2 = self::NEARRAL2_INVALID;       // Text
    protected $_nearRAL3 = self::NEARRAL3_INVALID;       // Text
    protected $_nearHTMLColor = self::NEARHTMLCOLOR_INVALID;  // Text
    protected $_nearSimpleColorIndex = self::NEARSIMPLECOLORINDEX_INVALID; // SimpleColor
    protected $_nearSimpleColor = self::NEARSIMPLECOLOR_INVALID; // Text
 ...
 * @return YColorSensor  a YColorSensor object allowing you to drive the color sensor.
 */
function yFindColorSensor(string $func): YColorSensor
{
 ...
 *         if there are none.
 */
function yFirstColorSensor(): ?YColorSensor
{
