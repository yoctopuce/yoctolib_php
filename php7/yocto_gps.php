...
/*********************************************************************
 *
 *  $Id: yocto_gps.php 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
//--- (YGps definitions)
if (!defined('Y_ISFIXED_FALSE')) {
    define('Y_ISFIXED_FALSE', 0);
}
if (!defined('Y_ISFIXED_TRUE')) {
    define('Y_ISFIXED_TRUE', 1);
}
if (!defined('Y_ISFIXED_INVALID')) {
    define('Y_ISFIXED_INVALID', -1);
}
if (!defined('Y_COORDSYSTEM_GPS_DMS')) {
    define('Y_COORDSYSTEM_GPS_DMS', 0);
}
if (!defined('Y_COORDSYSTEM_GPS_DM')) {
    define('Y_COORDSYSTEM_GPS_DM', 1);
}
if (!defined('Y_COORDSYSTEM_GPS_D')) {
    define('Y_COORDSYSTEM_GPS_D', 2);
}
if (!defined('Y_COORDSYSTEM_INVALID')) {
    define('Y_COORDSYSTEM_INVALID', -1);
}
if (!defined('Y_CONSTELLATION_GNSS')) {
    define('Y_CONSTELLATION_GNSS', 0);
}
if (!defined('Y_CONSTELLATION_GPS')) {
    define('Y_CONSTELLATION_GPS', 1);
}
if (!defined('Y_CONSTELLATION_GLONASS')) {
    define('Y_CONSTELLATION_GLONASS', 2);
}
if (!defined('Y_CONSTELLATION_GALILEO')) {
    define('Y_CONSTELLATION_GALILEO', 3);
}
if (!defined('Y_CONSTELLATION_GPS_GLONASS')) {
    define('Y_CONSTELLATION_GPS_GLONASS', 4);
}
if (!defined('Y_CONSTELLATION_GPS_GALILEO')) {
    define('Y_CONSTELLATION_GPS_GALILEO', 5);
}
if (!defined('Y_CONSTELLATION_GLONASS_GALILEO')) {
    define('Y_CONSTELLATION_GLONASS_GALILEO', 6);
}
if (!defined('Y_CONSTELLATION_INVALID')) {
    define('Y_CONSTELLATION_INVALID', -1);
}
if (!defined('Y_SATCOUNT_INVALID')) {
    define('Y_SATCOUNT_INVALID', YAPI_INVALID_LONG);
}
if (!defined('Y_SATPERCONST_INVALID')) {
    define('Y_SATPERCONST_INVALID', YAPI_INVALID_LONG);
}
if (!defined('Y_GPSREFRESHRATE_INVALID')) {
    define('Y_GPSREFRESHRATE_INVALID', YAPI_INVALID_DOUBLE);
}
if (!defined('Y_LATITUDE_INVALID')) {
    define('Y_LATITUDE_INVALID', YAPI_INVALID_STRING);
}
if (!defined('Y_LONGITUDE_INVALID')) {
    define('Y_LONGITUDE_INVALID', YAPI_INVALID_STRING);
}
if (!defined('Y_DILUTION_INVALID')) {
    define('Y_DILUTION_INVALID', YAPI_INVALID_DOUBLE);
}
if (!defined('Y_ALTITUDE_INVALID')) {
    define('Y_ALTITUDE_INVALID', YAPI_INVALID_DOUBLE);
}
if (!defined('Y_GROUNDSPEED_INVALID')) {
    define('Y_GROUNDSPEED_INVALID', YAPI_INVALID_DOUBLE);
}
if (!defined('Y_DIRECTION_INVALID')) {
    define('Y_DIRECTION_INVALID', YAPI_INVALID_DOUBLE);
}
if (!defined('Y_UNIXTIME_INVALID')) {
    define('Y_UNIXTIME_INVALID', YAPI_INVALID_LONG);
}
if (!defined('Y_DATETIME_INVALID')) {
    define('Y_DATETIME_INVALID', YAPI_INVALID_STRING);
}
if (!defined('Y_UTCOFFSET_INVALID')) {
...
class YGps extends YFunction
{
    ...
    //--- (YGps attributes)
    protected $_isFixed = self::ISFIXED_INVALID;        // Bool
    protected $_satCount = self::SATCOUNT_INVALID;       // UInt
    protected $_satPerConst = self::SATPERCONST_INVALID;    // UInt
    protected $_gpsRefreshRate = self::GPSREFRESHRATE_INVALID; // MeasureVal
    protected $_coordSystem = self::COORDSYSTEM_INVALID;    // GPSCoordinateSystem
    protected $_constellation = self::CONSTELLATION_INVALID;  // GPSConstellation
    protected $_latitude = self::LATITUDE_INVALID;       // Text
    protected $_longitude = self::LONGITUDE_INVALID;      // Text
    protected $_dilution = self::DILUTION_INVALID;       // MeasureVal
    protected $_altitude = self::ALTITUDE_INVALID;       // MeasureVal
    protected $_groundSpeed = self::GROUNDSPEED_INVALID;    // MeasureVal
    protected $_direction = self::DIRECTION_INVALID;      // MeasureVal
    protected $_unixTime = self::UNIXTIME_INVALID;       // UTCTime
    protected $_dateTime = self::DATETIME_INVALID;       // Text
    protected $_utcOffset = self::UTCOFFSET_INVALID;      // Int
 ...
 * @return YGps  a YGps object allowing you to drive the geolocalization module.
 */
function yFindGps(string $func): YGps
{
