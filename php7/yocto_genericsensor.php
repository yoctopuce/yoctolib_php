...
/*********************************************************************
 *
 *  $Id: yocto_genericsensor.php 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
class YGenericSensor extends YSensor
{
    ...
    protected $_signalRange = self::SIGNALRANGE_INVALID;    // ValueRange
    protected $_valueRange = self::VALUERANGE_INVALID;     // ValueRange
    protected $_signalBias = self::SIGNALBIAS_INVALID;     // MeasureVal
    protected $_signalSampling = self::SIGNALSAMPLING_INVALID; // SignalSampling
