...
/*********************************************************************
 *
 *  $Id: yocto_audioin.php 56082 2023-08-15 14:57:14Z mvuilleu $
 *
...
if (!defined('Y_VOLUMERANGE_INVALID')) {
    define('Y_VOLUMERANGE_INVALID', YAPI_INVALID_STRING);
}
if (!defined('Y_SIGNAL_INVALID')) {
    define('Y_SIGNAL_INVALID', YAPI_INVALID_INT);
}
if (!defined('Y_NOSIGNALFOR_INVALID')) {
...
class YAudioIn extends YFunction
{
    ...
    protected $_volumeRange = self::VOLUMERANGE_INVALID;    // ValueRange
    protected $_signal = self::SIGNAL_INVALID;         // Int
    protected $_noSignalFor = self::NOSIGNALFOR_INVALID;    // Int
 ...
 * @return YAudioIn  a YAudioIn object allowing you to drive the audio input.
 */
function yFindAudioIn(string $func): YAudioIn
{
 ...
 *         if there are none.
 */
function yFirstAudioIn(): ?YAudioIn
{
