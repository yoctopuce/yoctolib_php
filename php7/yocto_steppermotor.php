...
/*********************************************************************
 *
 *  $Id: yocto_steppermotor.php 56082 2023-08-15 14:57:14Z mvuilleu $
 *
...
class YStepperMotor extends YFunction
{
    ...
    protected $_motorState = self::MOTORSTATE_INVALID;     // StepperState
    protected $_diags = self::DIAGS_INVALID;          // StepperDiags
    protected $_stepPos = self::STEPPOS_INVALID;        // StepPos
    protected $_speed = self::SPEED_INVALID;          // MeasureVal
    protected $_pullinSpeed = self::PULLINSPEED_INVALID;    // MeasureVal
    protected $_maxAccel = self::MAXACCEL_INVALID;       // MeasureVal
    protected $_maxSpeed = self::MAXSPEED_INVALID;       // MeasureVal
    protected $_stepping = self::STEPPING_INVALID;       // SteppingMode
    protected $_overcurrent = self::OVERCURRENT_INVALID;    // UInt31
    protected $_tCurrStop = self::TCURRSTOP_INVALID;      // UInt31
    protected $_tCurrRun = self::TCURRRUN_INVALID;       // UInt31
    protected $_alertMode = self::ALERTMODE_INVALID;      // AlertMode
    protected $_auxMode = self::AUXMODE_INVALID;        // AuxMode
    protected $_auxSignal = self::AUXSIGNAL_INVALID;      // Int
