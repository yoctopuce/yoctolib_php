...
/*********************************************************************
 *
 *  $Id: yocto_rangefinder.php 56082 2023-08-15 14:57:14Z mvuilleu $
 *
...
if (!defined('Y_RANGEFINDERMODE_DEFAULT')) {
    define('Y_RANGEFINDERMODE_DEFAULT', 0);
}
if (!defined('Y_RANGEFINDERMODE_LONG_RANGE')) {
    define('Y_RANGEFINDERMODE_LONG_RANGE', 1);
}
if (!defined('Y_RANGEFINDERMODE_HIGH_ACCURACY')) {
    define('Y_RANGEFINDERMODE_HIGH_ACCURACY', 2);
}
if (!defined('Y_RANGEFINDERMODE_HIGH_SPEED')) {
    define('Y_RANGEFINDERMODE_HIGH_SPEED', 3);
}
if (!defined('Y_RANGEFINDERMODE_INVALID')) {
    define('Y_RANGEFINDERMODE_INVALID', -1);
}
if (!defined('Y_TIMEFRAME_INVALID')) {
    define('Y_TIMEFRAME_INVALID', YAPI_INVALID_LONG);
}
if (!defined('Y_QUALITY_INVALID')) {
    define('Y_QUALITY_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_HARDWARECALIBRATION_INVALID')) {
    define('Y_HARDWARECALIBRATION_INVALID', YAPI_INVALID_STRING);
}
if (!defined('Y_CURRENTTEMPERATURE_INVALID')) {
...
class YRangeFinder extends YSensor
{
    ...
    protected $_rangeFinderMode = self::RANGEFINDERMODE_INVALID; // RangeFinderMode
    protected $_timeFrame = self::TIMEFRAME_INVALID;      // Time
    protected $_quality = self::QUALITY_INVALID;        // Percent
    protected $_hardwareCalibration = self::HARDWARECALIBRATION_INVALID; // RangeFinderCalib
    protected $_currentTemperature = self::CURRENTTEMPERATURE_INVALID; // MeasureVal
 ...
 * @return YRangeFinder  a YRangeFinder object allowing you to drive the range finder.
 */
function yFindRangeFinder(string $func): YRangeFinder
{
 ...
 *         if there are none.
 */
function yFirstRangeFinder(): ?YRangeFinder
{
