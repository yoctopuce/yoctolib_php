...
/*********************************************************************
 *
 *  $Id: yocto_colorledcluster.php 52899 2023-01-25 11:45:44Z seb $
 *
...
if (!defined('Y_LEDTYPE_RGB')) {
    define('Y_LEDTYPE_RGB', 0);
}
if (!defined('Y_LEDTYPE_RGBW')) {
    define('Y_LEDTYPE_RGBW', 1);
}
if (!defined('Y_LEDTYPE_WS2811')) {
    define('Y_LEDTYPE_WS2811', 2);
}
if (!defined('Y_LEDTYPE_INVALID')) {
    define('Y_LEDTYPE_INVALID', -1);
}
if (!defined('Y_ACTIVELEDCOUNT_INVALID')) {
    define('Y_ACTIVELEDCOUNT_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_MAXLEDCOUNT_INVALID')) {
    define('Y_MAXLEDCOUNT_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_DYNAMICLEDCOUNT_INVALID')) {
    define('Y_DYNAMICLEDCOUNT_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_BLINKSEQMAXCOUNT_INVALID')) {
...
class YColorLedCluster extends YFunction
{
    ...
    protected $_activeLedCount = self::ACTIVELEDCOUNT_INVALID; // UInt31
    protected $_ledType = self::LEDTYPE_INVALID;        // LedType
    protected $_maxLedCount = self::MAXLEDCOUNT_INVALID;    // UInt31
    protected $_dynamicLedCount = self::DYNAMICLEDCOUNT_INVALID; // UInt31
    protected $_blinkSeqMaxCount = self::BLINKSEQMAXCOUNT_INVALID; // UInt31
    ...
    public function activeLedCount(): int
{
    ...
    public function setActiveLedCount(int $newval)
{
    ...
    public function ledType(): int
{
    ...
    public function setLedType(int $newval)
{
 ...
 * @return YColorLedCluster  a YColorLedCluster object allowing you to drive the RGB LED cluster.
 */
function yFindColorLedCluster(string $func): YColorLedCluster
{
 ...
 *         if there are none.
 */
function yFirstColorLedCluster(): ?YColorLedCluster
{
