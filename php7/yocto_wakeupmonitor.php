...
/*********************************************************************
 *
 *  $Id: yocto_wakeupmonitor.php 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
class YWakeUpMonitor extends YFunction
{
    ...
    protected $_powerDuration = self::POWERDURATION_INVALID;  // UInt31
    protected $_sleepCountdown = self::SLEEPCOUNTDOWN_INVALID; // UInt31
    protected $_nextWakeUp = self::NEXTWAKEUP_INVALID;     // UTCTime
    protected $_wakeUpReason = self::WAKEUPREASON_INVALID;   // WakeUpReason
    protected $_wakeUpState = self::WAKEUPSTATE_INVALID;    // WakeUpState
    protected $_rtcTime = self::RTCTIME_INVALID;        // UTCTime
