...
/*********************************************************************
 *
 *  $Id: yocto_carbondioxide.php 56082 2023-08-15 14:57:14Z mvuilleu $
 *
...
class YCarbonDioxide extends YSensor
{
    ...
    protected $_abcPeriod = self::ABCPERIOD_INVALID;      // UInt31
 ...
 * @return YCarbonDioxide  a YCarbonDioxide object allowing you to drive the CO2 sensor.
 */
function yFindCarbonDioxide(string $func): YCarbonDioxide
{
 ...
 *         if there are none.
 */
function yFirstCarbonDioxide(): ?YCarbonDioxide
{
