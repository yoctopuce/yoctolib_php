...
/*********************************************************************
 *
 *  $Id: yocto_hubport.php 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
if (!defined('Y_PORTSTATE_OFF')) {
    define('Y_PORTSTATE_OFF', 0);
}
if (!defined('Y_PORTSTATE_OVRLD')) {
    define('Y_PORTSTATE_OVRLD', 1);
}
if (!defined('Y_PORTSTATE_ON')) {
    define('Y_PORTSTATE_ON', 2);
}
if (!defined('Y_PORTSTATE_RUN')) {
    define('Y_PORTSTATE_RUN', 3);
}
if (!defined('Y_PORTSTATE_PROG')) {
    define('Y_PORTSTATE_PROG', 4);
}
if (!defined('Y_PORTSTATE_INVALID')) {
    define('Y_PORTSTATE_INVALID', -1);
}
if (!defined('Y_BAUDRATE_INVALID')) {
...
class YHubPort extends YFunction
{
    ...
    protected $_portState = self::PORTSTATE_INVALID;      // PortState
    protected $_baudRate = self::BAUDRATE_INVALID;       // BaudRate
 ...
 * @return YHubPort  a YHubPort object allowing you to drive the YoctoHub slave port.
 */
function yFindHubPort(string $func): YHubPort
{
 ...
 *         if there are none.
 */
function yFirstHubPort(): ?YHubPort
{
