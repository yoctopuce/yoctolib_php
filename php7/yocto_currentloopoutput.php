...
/*********************************************************************
 *
 *  $Id: yocto_currentloopoutput.php 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
if (!defined('Y_LOOPPOWER_NOPWR')) {
    define('Y_LOOPPOWER_NOPWR', 0);
}
if (!defined('Y_LOOPPOWER_LOWPWR')) {
    define('Y_LOOPPOWER_LOWPWR', 1);
}
if (!defined('Y_LOOPPOWER_POWEROK')) {
    define('Y_LOOPPOWER_POWEROK', 2);
}
if (!defined('Y_LOOPPOWER_INVALID')) {
    define('Y_LOOPPOWER_INVALID', -1);
}
if (!defined('Y_CURRENT_INVALID')) {
    define('Y_CURRENT_INVALID', YAPI_INVALID_DOUBLE);
}
if (!defined('Y_CURRENTTRANSITION_INVALID')) {
...
class YCurrentLoopOutput extends YFunction
{
    ...
    protected $_current = self::CURRENT_INVALID;        // MeasureVal
    protected $_currentTransition = self::CURRENTTRANSITION_INVALID; // AnyFloatTransition
    protected $_currentAtStartUp = self::CURRENTATSTARTUP_INVALID; // MeasureVal
    protected $_loopPower = self::LOOPPOWER_INVALID;      // LoopPwrState
 ...
 * @return YCurrentLoopOutput  a YCurrentLoopOutput object allowing you to drive the 4-20mA output.
 */
function yFindCurrentLoopOutput(string $func): YCurrentLoopOutput
{
 ...
 *         if there are none.
 */
function yFirstCurrentLoopOutput(): ?YCurrentLoopOutput
{
