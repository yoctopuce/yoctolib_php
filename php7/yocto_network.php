...
/*********************************************************************
 *
 *  $Id: yocto_network.php 52931 2023-01-26 09:31:41Z seb $
 *
...
class YNetwork extends YFunction
{
    ...
    //--- (YNetwork attributes)
    protected $_readiness = self::READINESS_INVALID;      // Readiness
    protected $_macAddress = self::MACADDRESS_INVALID;     // MACAddress
    protected $_ipAddress = self::IPADDRESS_INVALID;      // IPAddress
    protected $_subnetMask = self::SUBNETMASK_INVALID;     // IPAddress
    protected $_router = self::ROUTER_INVALID;         // IPAddress
    protected $_currentDNS = self::CURRENTDNS_INVALID;     // IPAddress
    protected $_ipConfig = self::IPCONFIG_INVALID;       // IPConfig
    protected $_primaryDNS = self::PRIMARYDNS_INVALID;     // IPAddress
    protected $_secondaryDNS = self::SECONDARYDNS_INVALID;   // IPAddress
    protected $_ntpServer = self::NTPSERVER_INVALID;      // IPAddress
    protected $_userPassword = self::USERPASSWORD_INVALID;   // UserPassword
    protected $_adminPassword = self::ADMINPASSWORD_INVALID;  // AdminPassword
    protected $_httpPort = self::HTTPPORT_INVALID;       // UInt31
    protected $_defaultPage = self::DEFAULTPAGE_INVALID;    // Text
    protected $_discoverable = self::DISCOVERABLE_INVALID;   // Bool
    protected $_wwwWatchdogDelay = self::WWWWATCHDOGDELAY_INVALID; // UInt31
    protected $_callbackUrl = self::CALLBACKURL_INVALID;    // Text
    protected $_callbackMethod = self::CALLBACKMETHOD_INVALID; // HTTPMethod
    protected $_callbackEncoding = self::CALLBACKENCODING_INVALID; // CallbackEncoding
    protected $_callbackCredentials = self::CALLBACKCREDENTIALS_INVALID; // Credentials
    protected $_callbackInitialDelay = self::CALLBACKINITIALDELAY_INVALID; // UInt31
    protected $_callbackSchedule = self::CALLBACKSCHEDULE_INVALID; // CallbackSchedule
    protected $_callbackMinDelay = self::CALLBACKMINDELAY_INVALID; // UInt31
    protected $_callbackMaxDelay = self::CALLBACKMAXDELAY_INVALID; // UInt31
    protected $_poeCurrent = self::POECURRENT_INVALID;     // UsedCurrent
    ...
    public function ipConfig(): string
{
    ...
    public function setIpConfig(string $newval)
{
    ...
    public function primaryDNS(): string
{
    ...
    public function setPrimaryDNS(string $newval)
{
    ...
    public function secondaryDNS(): string
{
    ...
    public function setSecondaryDNS(string $newval)
{
    ...
    public function ntpServer(): string
{
    ...
    public function setNtpServer(string $newval)
{
    ...
    public function userPassword(): string
{
    ...
    public function setUserPassword(string $newval)
{
    ...
    public function adminPassword(): string
{
    ...
    public function setAdminPassword(string $newval)
{
    ...
    public function httpPort(): int
{
    ...
    public function setHttpPort(int $newval)
{
    ...
    public function defaultPage(): string
{
    ...
    public function setDefaultPage(string $newval)
{
    ...
    public function discoverable(): int
{
    ...
    public function setDiscoverable(int $newval)
{
    ...
    public function wwwWatchdogDelay(): int
{
    ...
    public function setWwwWatchdogDelay(int $newval)
{
    ...
    public function callbackUrl(): string
{
    ...
    public function setCallbackUrl(string $newval)
{
    ...
    public function callbackMethod(): int
{
    ...
    public function setCallbackMethod(int $newval)
{
    ...
    public function callbackEncoding(): int
{
    ...
    public function setCallbackEncoding(int $newval)
{
    ...
    public function callbackCredentials(): string
{
    ...
    public function setCallbackCredentials(string $newval)
{
    ...
    public function callbackInitialDelay(): int
{
    ...
    public function setCallbackInitialDelay(int $newval)
{
    ...
    public function callbackSchedule(): string
{
    ...
    public function setCallbackSchedule(string $newval)
{
    ...
    public function callbackMinDelay(): int
{
    ...
    public function setCallbackMinDelay(int $newval)
{
    ...
    public function callbackMaxDelay(): int
{
    ...
    public function setCallbackMaxDelay(int $newval)
{
