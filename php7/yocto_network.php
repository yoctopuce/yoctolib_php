...
/*********************************************************************
 *
 *  $Id: yocto_network.php 60428 2024-04-08 12:57:43Z seb $
 *
...
class YNetwork extends YFunction
{
    ...
    protected $_httpsPort = self::HTTPSPORT_INVALID;      // UInt31
    protected $_securityMode = self::SECURITYMODE_INVALID;   // SecurityMode
    ...
    protected $_callbackTemplate = self::CALLBACKTEMPLATE_INVALID; // OnOff
