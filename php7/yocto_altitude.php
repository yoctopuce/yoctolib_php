...
/*********************************************************************
 *
 *  $Id: yocto_altitude.php 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
if (!defined('Y_QNH_INVALID')) {
    define('Y_QNH_INVALID', YAPI_INVALID_DOUBLE);
}
if (!defined('Y_TECHNOLOGY_INVALID')) {
...
class YAltitude extends YSensor
{
    ...
    protected $_qnh = self::QNH_INVALID;            // MeasureVal
    protected $_technology = self::TECHNOLOGY_INVALID;     // Text
 ...
 * @return YAltitude  a YAltitude object allowing you to drive the altimeter.
 */
function yFindAltitude(string $func): YAltitude
{
 ...
 *         if there are none.
 */
function yFirstAltitude(): ?YAltitude
{
