...
/*********************************************************************
 *
 *  $Id: yocto_refframe.php 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
if (!defined('Y_FUSIONMODE_NDOF')) {
    define('Y_FUSIONMODE_NDOF', 0);
}
if (!defined('Y_FUSIONMODE_NDOF_FMC_OFF')) {
    define('Y_FUSIONMODE_NDOF_FMC_OFF', 1);
}
if (!defined('Y_FUSIONMODE_M4G')) {
    define('Y_FUSIONMODE_M4G', 2);
}
if (!defined('Y_FUSIONMODE_COMPASS')) {
    define('Y_FUSIONMODE_COMPASS', 3);
}
if (!defined('Y_FUSIONMODE_IMU')) {
    define('Y_FUSIONMODE_IMU', 4);
}
if (!defined('Y_FUSIONMODE_INCLIN_90DEG_1G8')) {
    define('Y_FUSIONMODE_INCLIN_90DEG_1G8', 5);
}
if (!defined('Y_FUSIONMODE_INCLIN_90DEG_3G6')) {
    define('Y_FUSIONMODE_INCLIN_90DEG_3G6', 6);
}
if (!defined('Y_FUSIONMODE_INCLIN_10DEG')) {
    define('Y_FUSIONMODE_INCLIN_10DEG', 7);
}
if (!defined('Y_FUSIONMODE_INVALID')) {
    define('Y_FUSIONMODE_INVALID', -1);
}
const Y_MOUNTPOSITION_BOTTOM = 0;
const Y_MOUNTPOSITION_TOP = 1;
const Y_MOUNTPOSITION_FRONT = 2;
const Y_MOUNTPOSITION_REAR = 3;
const Y_MOUNTPOSITION_RIGHT = 4;
const Y_MOUNTPOSITION_LEFT = 5;
const Y_MOUNTPOSITION_INVALID = 6;
const Y_MOUNTORIENTATION_TWELVE = 0;
const Y_MOUNTORIENTATION_THREE = 1;
const Y_MOUNTORIENTATION_SIX = 2;
const Y_MOUNTORIENTATION_NINE = 3;
const Y_MOUNTORIENTATION_INVALID = 4;
if (!defined('Y_MOUNTPOS_INVALID')) {
    define('Y_MOUNTPOS_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_BEARING_INVALID')) {
...
class YRefFrame extends YFunction
{
    ...
    protected $_mountPos = self::MOUNTPOS_INVALID;       // UInt31
    protected $_bearing = self::BEARING_INVALID;        // MeasureVal
    protected $_calibrationParam = self::CALIBRATIONPARAM_INVALID; // CalibParams
    protected $_fusionMode = self::FUSIONMODE_INVALID;     // FusionModeTypeAll
    protected $_calibV2 = false;                        // bool
    ...
    protected $_calibOrient = [];                           // intArr
    protected $_calibDataAccX = [];                           // floatArr
    protected $_calibDataAccY = [];                           // floatArr
    protected $_calibDataAccZ = [];                           // floatArr
    protected $_calibDataAcc = [];                           // floatArr
 ...
 * @return YRefFrame  a YRefFrame object allowing you to drive the reference frame.
 */
function yFindRefFrame(string $func): YRefFrame
{
 ...
 *         if there are none.
 */
function yFirstRefFrame(): ?YRefFrame
{
