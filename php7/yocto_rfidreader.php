...
class YRfidTagInfo
{
    ...
    protected $_tagId = "";                           // str
    protected $_tagType = 0;                            // int
    protected $_typeStr = "";                           // str
    protected $_size = 0;                            // int
    protected $_usable = 0;                            // int
    protected $_blksize = 0;                            // int
    protected $_fblk = 0;                            // int
    protected $_lblk = 0;                            // int
     ...
     */
    public function imm_init(string $tagId, int $tagType, int $size, int $usable, int $blksize, int $fblk, int $lblk)
    {
        // $typeStr                is a str;
        $typeStr = 'unknown';
...
class YRfidStatus
{
    ...
    protected $_tagId = "";                           // str
    protected $_errCode = 0;                            // int
    protected $_errBlk = 0;                            // int
    protected $_errMsg = "";                           // str
    protected $_yapierr = 0;                            // int
    protected $_fab = 0;                            // int
    protected $_lab = 0;                            // int
     ...
     * @throws YAPI_Exception on error
     */
    public function imm_init(string $tagId, int $errCode, int $errBlk, int $fab, int $lab)
    {
        // $errMsg                 is a str;
        if ($errCode == 0) {
...
class YRfidReader extends YFunction
{
    ...
    protected $_nTags = self::NTAGS_INVALID;          // UInt31
