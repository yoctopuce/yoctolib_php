...
/*********************************************************************
 *
 *  $Id: yocto_multiaxiscontroller.php 56082 2023-08-15 14:57:14Z mvuilleu $
 *
...
if (!defined('Y_GLOBALSTATE_ABSENT')) {
    define('Y_GLOBALSTATE_ABSENT', 0);
}
if (!defined('Y_GLOBALSTATE_ALERT')) {
    define('Y_GLOBALSTATE_ALERT', 1);
}
if (!defined('Y_GLOBALSTATE_HI_Z')) {
    define('Y_GLOBALSTATE_HI_Z', 2);
}
if (!defined('Y_GLOBALSTATE_STOP')) {
    define('Y_GLOBALSTATE_STOP', 3);
}
if (!defined('Y_GLOBALSTATE_RUN')) {
    define('Y_GLOBALSTATE_RUN', 4);
}
if (!defined('Y_GLOBALSTATE_BATCH')) {
    define('Y_GLOBALSTATE_BATCH', 5);
}
if (!defined('Y_GLOBALSTATE_INVALID')) {
    define('Y_GLOBALSTATE_INVALID', -1);
}
if (!defined('Y_NAXIS_INVALID')) {
...
class YMultiAxisController extends YFunction
{
    ...
    protected $_nAxis = self::NAXIS_INVALID;          // UInt31
    protected $_globalState = self::GLOBALSTATE_INVALID;    // StepperState
 ...
 * @return YMultiAxisController  a YMultiAxisController object allowing you to drive the multi-axis controller.
 */
function yFindMultiAxisController(string $func): YMultiAxisController
{
 ...
 *         if there are none.
 */
function yFirstMultiAxisController(): ?YMultiAxisController
{
