...
/*********************************************************************
 *
 * $Id: yocto_serialport.php 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
class YSerialPort extends YFunction
{
     ...
     * @throws YAPI_Exception on error
     */
    public function registerSnoopingCallback( $callback): int
    {
        if (!is_null($callback)) {
 ...
 * @return YSerialPort  a YSerialPort object allowing you to drive the serial port.
 */
function yFindSerialPort(string $func): YSerialPort
{
 ...
 *         if there are none.
 */
function yFirstSerialPort(): ?YSerialPort
{
