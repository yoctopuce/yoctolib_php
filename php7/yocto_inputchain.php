...
if (!defined('Y_LOOPBACKTEST_OFF')) {
    define('Y_LOOPBACKTEST_OFF', 0);
}
if (!defined('Y_LOOPBACKTEST_ON')) {
    define('Y_LOOPBACKTEST_ON', 1);
}
if (!defined('Y_LOOPBACKTEST_INVALID')) {
    define('Y_LOOPBACKTEST_INVALID', -1);
}
if (!defined('Y_EXPECTEDNODES_INVALID')) {
    define('Y_EXPECTEDNODES_INVALID', YAPI_INVALID_UINT);
}
if (!defined('Y_DETECTEDNODES_INVALID')) {
...
class YInputChain extends YFunction
{
    ...
    protected $_expectedNodes = self::EXPECTEDNODES_INVALID;  // UInt31
    protected $_detectedNodes = self::DETECTEDNODES_INVALID;  // UInt31
    protected $_loopbackTest = self::LOOPBACKTEST_INVALID;   // OnOff
    protected $_refreshRate = self::REFRESHRATE_INVALID;    // UInt31
    protected $_bitChain1 = self::BITCHAIN1_INVALID;      // Text
    protected $_bitChain2 = self::BITCHAIN2_INVALID;      // Text
    protected $_bitChain3 = self::BITCHAIN3_INVALID;      // Text
    protected $_bitChain4 = self::BITCHAIN4_INVALID;      // Text
    protected $_bitChain5 = self::BITCHAIN5_INVALID;      // Text
    protected $_bitChain6 = self::BITCHAIN6_INVALID;      // Text
 ...
 * @return YInputChain  a YInputChain object allowing you to drive the digital input chain.
 */
function yFindInputChain(string $func): YInputChain
{
 ...
 *         if there are none.
 */
function yFirstInputChain(): ?YInputChain
{
