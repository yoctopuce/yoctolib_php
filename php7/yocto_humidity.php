...
/*********************************************************************
 *
 *  $Id: yocto_humidity.php 56082 2023-08-15 14:57:14Z mvuilleu $
 *
...
if (!defined('Y_RELHUM_INVALID')) {
    define('Y_RELHUM_INVALID', YAPI_INVALID_DOUBLE);
}
if (!defined('Y_ABSHUM_INVALID')) {
...
class YHumidity extends YSensor
{
    ...
    protected $_relHum = self::RELHUM_INVALID;         // MeasureVal
    protected $_absHum = self::ABSHUM_INVALID;         // MeasureVal
 ...
 * @return YHumidity  a YHumidity object allowing you to drive the humidity sensor.
 */
function yFindHumidity(string $func): YHumidity
{
 ...
 *         if there are none.
 */
function yFirstHumidity(): ?YHumidity
{
