...
/*********************************************************************
 *
 *  $Id: yocto_bluetoothlink.php 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
class YBluetoothLink extends YFunction
{
    ...
    protected $_ownAddress = self::OWNADDRESS_INVALID;     // MACAddress
    protected $_pairingPin = self::PAIRINGPIN_INVALID;     // Text
    protected $_remoteAddress = self::REMOTEADDRESS_INVALID;  // MACAddress
    protected $_remoteName = self::REMOTENAME_INVALID;     // Text
    protected $_mute = self::MUTE_INVALID;           // Bool
    protected $_preAmplifier = self::PREAMPLIFIER_INVALID;   // Percent
    protected $_volume = self::VOLUME_INVALID;         // Percent
    protected $_linkState = self::LINKSTATE_INVALID;      // BtState
