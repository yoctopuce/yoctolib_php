...
/*********************************************************************
 *
 * $Id: yocto_carbondioxide.php 12324 2013-08-13 15:10:31Z mvuilleu $
 *
 ...
 */
class YCarbonDioxide extends YFunction
{
     ...
     */
    public static function FindCarbonDioxide($str_func)
    {   $obj_func = YAPI::getFunction('CarbonDioxide', $str_func);
    ...
    function __construct($str_func)
    {
        ...
        parent::__construct('CarbonDioxide', $str_func);
