...
/*********************************************************************
 *
 * $Id: yocto_humidity.php 11112 2013-04-16 14:51:20Z mvuilleu $
 *
 ...
 */
class YHumidity extends YFunction
{
     ...
     */
    public static function FindHumidity($str_func)
    {   $obj_func = YAPI::getFunction('Humidity', $str_func);
    ...
    function __construct($str_func)
    {
        ...
        parent::__construct('Humidity', $str_func);
